// source.particles.sweep_chamber — tracer line vertex shader.
// One oriented quad per segment (6 verts), read by instance id; degenerate
// (collapsed) for zeroed/dead segments. double_chamber parity.
